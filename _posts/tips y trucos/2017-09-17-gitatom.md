...
{% include imagen source="screenshot/pullypush-atom.png" alt="Ejemplo de las opciones de pull (descargar) y push (subir) en Atom." %}
...
## Imágenes
{% include imagen source="screenshot/atom.png" alt="Pantalla Atom." %}
{% include imagen source="screenshot/atomdiff.png" alt="Vista de dieferencias de código de Atom." %}
{% include imagen source="screenshot/import.png" alt="Importando proyectos a Atom." %}
