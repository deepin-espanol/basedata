...
{% include imagen source="screenshot/conf-terminal.png" alt="Configuración en la terminal." %}
{% include imagen source="screenshot/conf-terminal2.png" alt="Configuración en la terminal." %}
