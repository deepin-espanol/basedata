...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{ site.url }}{{ site.baseurl }}/deepin/kodi">Rambox</a>, <a href="{{ site.url }}{{ site.baseurl }}/deepin/webcatalog">WebCatalog</a>, Franz</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Clientes VPN</td>
      <td><b>Centro de control (integrado)</b>, <a href="{{ site.url }}{{ site.baseurl }}/deepin/pritunl">Pritunl Client</a></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><b>Deepin Movies</b>, <a href="{{ site.url }}{{ site.baseurl }}/deepin/vlc">VLC</a>, MPV, SMPlayer</td>
    </tr>
    <tr>
