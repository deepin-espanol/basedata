...
Este es un aporte para conseguir las credenciales del usuario y de [administrador]({{ site.url }}{{ site.baseurl }}/deepin/usuarios-root/). Recuerda que la contraseña es indispensable para iniciar sesión. Si quieres evitar que intrusos accedan a Deepin, tienes esta opción.
...
* [Cambiar permisos de usuario]({{ site.url }}{{ site.baseurl }}deepin/permisos-usuario/).
